...
@Component({
  selector: 'app-gujrati-papdi',
  templateUrl: './gujrati-papdi.component.html',
  styleUrls: ['./gujrati-papdi.component.scss']
})
export class GujratiPapdiComponent implements OnInit , AfterViewInit {
  constructor() {}
