...
@Component({
  selector: 'app-mini-kachori',
  templateUrl: './mini-kachori.component.html',
  styleUrls: ['./mini-kachori.component.scss']
})
export class MiniKachoriComponent implements OnInit, AfterViewInit {
  constructor() {}
