...
@Component({
  selector: 'app-steam-basmati',
  templateUrl: './steam-basmati.component.html',
  styleUrls: ['./steam-basmati.component.scss']
})
export class SteamBasmatiComponent implements OnInit , AfterViewInit {
  constructor() {}
